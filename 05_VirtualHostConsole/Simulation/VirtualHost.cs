...
namespace Yanets.VirtualHostConsole.Simulation
{
    public class VirtualHost : IVirtualHost
    {
        ...
        public event EventHandler<HostStatusEventArgs> StatusChanged;
        ...
        public async Task StartAsync()
        {
            ...
            try
            {
                ...
                OnStatusChanged(new HostStatusEventArgs { Status = Status });
        ...
        {
            var interfaceInfo = NetworkStack.GetInterfaceByName(interfaceName);
...
interface Management
 ...
 no shutdown
        ...
        private void OnStatusChanged(HostStatusEventArgs e)
        {
